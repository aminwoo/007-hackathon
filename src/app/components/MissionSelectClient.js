  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto" onClick={handleSkipAnimations}>
        ...
        {/* Mission Selection */}
        <div className={`mb-8 bg-black border border-green-700 p-6 ${skipAnimations ? 'opacity-100' : 'fade-in'}`} style={skipAnimations ? {} : { animationDuration: '1s', animationDelay: '0.5s' }}>
        ...
        {/* Action Buttons */}
        <div className={`flex justify-between mb-8 ${skipAnimations ? 'opacity-100' : 'fade-in'}`} style={skipAnimations ? {} : { animationDuration: '1s', animationDelay: '1.5s' }}>
          <Link 
            href="/"
